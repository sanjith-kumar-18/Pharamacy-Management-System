...
//    public Patient
    ...
    private void addContact(Employee employee){
        try{
            ...
            new MyLogger("Exception: (addContact)" + e);
        }
    }//done
    ...
    public void createMedicineList(){
        try{
            ...
            new MyLogger("Exception: " + e.getMessage());
        }
    }//done
    public Medicines getMed(String name)  {
        try{
            ...
            new MyLogger("Exception:(getMed) " + e.getMessage());
            return null;
        }
    }//done
    ...
    public void addPatient(Patient newPat){
        try {
            ...
            new MyLogger("Exception:(addPatient) " + e.getMessage());
        }
    }//done
    ...
    public String generatePatID(){
        try{
            ...
            new MyLogger("Exception: (generatePatId)"  + e);
        }
        return null;
    }
...
//            }
            ...
            new MyLogger("Exception:(addToBill) " + e.getMessage());
        }
    }
    ...
    private String getBillId(){
        try{
            ...
            System.out.println("Exception: (getEmpId)"  + e);
            new MyLogger("Exception: (getEmpId)"  + e);
        }
        return null;
    }
