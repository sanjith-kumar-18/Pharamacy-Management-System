...
//                primaryStage.setTitle("Hello ");
                ...
                new MyLogger("Exception: (login->homePage)" + exception);
            }
        }catch (Exception e){
            System.out.println("Exception(onLogoutClicked):" + e.getMessage());
            new MyLogger("Exception(onLogoutClicked):" + e.getMessage());
        }
    }
...
//                primaryStage.setTitle("Hello ");
            ...
            new MyLogger("Exception(onSettingClicked):" + e.getMessage());
        }
    }
...
//            notifyStage.setTitle("Hello ");
            ...
            new MyLogger("Exception(onNotificationClicked):" + e.getMessage());
        }
    }
